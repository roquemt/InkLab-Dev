...
void HAL_SPI_MspInit(SPI_HandleTypeDef* hspi)
{
  ...
  else if(hspi->Instance==SPI2)
  {
    ...
    */
    ...
    /* SPI2 interrupt Init */
    HAL_NVIC_SetPriority(SPI2_3_IRQn, 3, 0);
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* hspi)
{
  ...
  else if(hspi->Instance==SPI2)
  {
    ...
    */
    ...
    /* USER CODE BEGIN SPI2:SPI2_3_IRQn disable */
    /**
    * Uncomment the line below to disable the "SPI2_3_IRQn" interrupt
    * Be aware, disabling shared interrupt may affect other IPs
    */
    /* HAL_NVIC_DisableIRQ(SPI2_3_IRQn); */
    /* USER CODE END SPI2:SPI2_3_IRQn disable */
  ...
  else if(hspi->Instance==SPI3)
  {
    ...
    */
    ...
    /* USER CODE BEGIN SPI3:SPI2_3_IRQn disable */
    /**
    * Uncomment the line below to disable the "SPI2_3_IRQn" interrupt
    * Be aware, disabling shared interrupt may affect other IPs
    */
    /* HAL_NVIC_DisableIRQ(SPI2_3_IRQn); */
    /* USER CODE END SPI3:SPI2_3_IRQn disable */
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* htim)
{
  ...
  if(htim->Instance==TIM1)
  {
    ...
    */
    ...
    HAL_GPIO_Init(MCU_CLK_GPIO_Port, &GPIO_InitStruct);
